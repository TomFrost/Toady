...
module.exports = function(config, client) {
  return {
    name: 'Remote Control',
    desc: "Allows for remote execution of the IRC client's primary functions",
    author: 'Tom Shawver',
    commands: {
      me: {
        ...
        help: [
          ...
          ' ',
          "If this is said in a channel, I'll repeat it to the same room if " +
            'no other channel is specified.'
        ],
        targetChannel: true,
        minPermission: '+',
        pattern: /^.+$/
      ...
      join: {
        handler: function(from, to, target) {
          client.join(target);
        },
      ...
      part: {
        ...
        help: [
          ...
          '  !{cmd}',
          'If the channel is omitted and the message was said in the ' +
            'channel, the bot will leave that channel.'
        ],
        minPermission: '@',
        targetChannel: true
      }
